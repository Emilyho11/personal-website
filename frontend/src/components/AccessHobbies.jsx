...
import moveU from '../assets/images/hobbies/end_of_year_celebration_moveU.jpg';
import Swimming from '../assets/images/hobbies/swimming.jpg';
import Skating from '../assets/images/hobbies/skating.jpg';
...
const hobbies = [
    ...
    {
        hobbyName: 'Swimming',
        description: 'I have been swimming and taking swimming lessons since I was 6, and I aimed to get my lifeguard certifications. I have been swimming for 10 years. I received my Bronze Medallion, but after that, COVID hit and prevented me from completing it. However, to this day, swimming is still a hobby I enjoy.',
        date: '2009-2019',
        image: [Swimming]
    },
    {
        hobbyName: 'Skating',
        description: 'I took skating lessons for 10 years. However, when COVID-19 came, I did not get to skate as often anymore.',
        date: '2009-2019',
        image: [Skating]
    },
    {
